...
if not args.evaluate and args.test_dataset != "psb":
...
elif args.evaluate and args.test_dataset != "psb":
...
elif not args.evaluate and args.test_dataset == "psb":
    train_dataset = PSBDataset(dataset_path, name=args.train_dataset, train=True,
                                      k_eig=k_eig, n_fmap=n_fmap, use_cache=True, op_cache_dir=op_cache_dir)
    train_loader = torch.utils.data.DataLoader(
        train_dataset, batch_size=None, shuffle=True)

elif args.evaluate and args.test_dataset == "psb":
    test_dataset = PSBDataset(dataset_path, name=args.test_dataset, train=False,
                                    k_eig=k_eig, n_fmap=n_fmap, use_cache=True, op_cache_dir=op_cache_dir)
    test_loader = torch.utils.data.DataLoader(
        test_dataset, batch_size=None, shuffle=False)
