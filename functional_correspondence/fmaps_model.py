...
class FunctionalMapCorrespondenceWithDiffusionNetFeaturesWithoutVts(nn.Module):
    """Compute the functional map matrix representation."""
    ...
    def forward(self, shape1, shape2):
        verts1, faces1, frames1, mass1, L1, evals1, evecs1, gradX1, gradY1, hks1 = shape1 # , vts1 
        verts2, faces2, frames2, mass2, L2, evals2, evecs2, gradX2, gradY2, hks2 = shape2 # , vts2
