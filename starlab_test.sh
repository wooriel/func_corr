...
python3.8 experiments/functional_correspondence/find_model_correspondence.py --test_dataset=psb --input_feature=hks --load_model=experiments/functional_correspondence/pretrained_models/starlab_hks.pth --evaluate --num_test=10
