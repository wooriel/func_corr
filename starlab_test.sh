...
python3.8 experiments/functional_correspondence/find_model_correspondence.py --evaluate --test_dataset=psb --input_features=hks --load_model=experiments/functional_correspondence/pretrained_models/starlab_hks.pth --top_k=2
